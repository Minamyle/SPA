            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <Select
                    ...
                    options={brands?.filter(brand => typeof brand === 'string').map(brand => ({
                      value: brand,
                      label: brand
                    })) || []}
                  />
                ...
                <div>
                  <Select
                    ...
                    options={categories?.filter(category => typeof category === 'string').map(category => ({
                      value: category,
              ...
              <div className="space-y-4">
                <FileUpload
                  ...
                  onFilesChange={(files) => setValue('thumbnail', files[0] || '')}
