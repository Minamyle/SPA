          ...
          <div className="flex-1 overflow-y-auto p-6">
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-card-foreground">Your cart is empty</h3>
              ...
              <div className="space-y-4">
                {items.map((item) => {
                  ...
                  return (
                    <div key={item.product.id} className="bg-card border border-border/50 rounded-xl p-4 space-y-3">
